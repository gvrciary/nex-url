...
const BASE_STYLES =
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-normal transition-[background-color,color,box-shadow,transform] duration-150 ease-out active:scale-[0.96] focus:outline-none focus:ring-2 focus:ring-gray-400 dark:focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100";
