...
export default function Button({
  ...
  const variants = {
    ...
    outline: 'border border-gray-300 dark:border-white text-black dark:text-white hover:bg-gray-100 dark:hover:bg-white hover:text-black dark:hover:text-black',
